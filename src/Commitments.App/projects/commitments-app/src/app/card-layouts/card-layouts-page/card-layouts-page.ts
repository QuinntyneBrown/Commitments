...
@Component({
  templateUrl: "./card-layouts-page.html",
  styleUrls: ["./card-layouts-page.scss"],
  selector: "app-card-layouts-page"
})
export class CardLayoutsPage {
  constructor(
    private readonly _cardLayoutService: CardLayoutService,
    private readonly _editCardLayoutOverlay: EditCardLayoutOverlayService,
