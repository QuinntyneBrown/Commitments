...
import { DashboardCard as DashboardCardModel } from "../dashboard-card";
import { DashboardCardService } from "../dashboard-card.service";
import { FormGroup, FormControl, Validators } from "@angular/forms";
import { takeUntil, map } from "rxjs";

@Component({
  templateUrl: "./dashboard-card-configuration-overlay.html",
  styleUrls: ["./dashboard-card-configuration-overlay.scss"],
...
export class DashboardCardConfigurationOverlay {
  ...
  public dashboardCard: DashboardCardModel;
