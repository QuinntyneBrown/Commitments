...
@Component({
  templateUrl: "./relations-results-dashboard-card.html",
  styleUrls: [
    "../dashboard-cards/dashboard-card.component.scss",
    "./relations-results-dashboard-card.scss"
  ],
  selector: "app-daily-results-dashboard-card"
})
export class RelationsResultsDashboardCard extends DashboardCardComponent {
  constructor(
