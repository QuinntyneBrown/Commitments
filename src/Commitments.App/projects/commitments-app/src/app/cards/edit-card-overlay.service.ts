...
@Injectable()
export class EditCardOverlayService {
  constructor(
  ...
  public attachOverlayContainer(overlayRef, overlayRefWrapper) {
    ...
    const overlayPortal = new ComponentPortal(EditCardOverlay, null, injector);
    const overlayPortalRef: ComponentRef<EditCardOverlay> = overlayRef.attach(overlayPortal);
