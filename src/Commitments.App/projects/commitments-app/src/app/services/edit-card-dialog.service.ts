...
export class EditCardDialogService {
  ...
  public attachOverlayContainer(overlayRef, overlayRefWrapper) {
    ...
    const overlayPortal = new ComponentPortal(EditCardDialogComponent, null, injector);
    const overlayPortalRef: ComponentRef<EditCardDialogComponent> = overlayRef.attach(overlayPortal);
