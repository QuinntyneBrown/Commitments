...
@Component({
  templateUrl: "./digital-asset-url-input.html",
  styleUrls: ["./digital-asset-url-input.scss"],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DigitalAssetInputUrl),
      multi: true
    }
  ],
  selector: "app-digital-asset-input-url"
})
export class DigitalAssetInputUrl implements ControlValueAccessor {
  constructor(
