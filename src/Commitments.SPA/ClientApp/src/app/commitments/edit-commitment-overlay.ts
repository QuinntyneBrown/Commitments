...
@Injectable()
export class EditCommitmentOverlay {
  constructor(
  ...
  public attachOverlayContainer(overlayRef, overlayRefWrapper) {
    ...
    const overlayPortal = new ComponentPortal(EditCommitmentOverlayComponent, null, injector);
    const overlayPortalRef: ComponentRef<EditCommitmentOverlayComponent> = overlayRef.attach(overlayPortal);
