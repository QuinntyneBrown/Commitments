...
namespace Commitments.Infrastructure.Migrations
{
    ...
    [Migration("20180518083800_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commitments.Core.Entities.Commitment", b =>
                {
                    ...
                    b.HasIndex("CommitmentFailFrequencyId");

                    b.HasIndex("CommitmentFrequencyId");
            ...
            modelBuilder.Entity("Commitments.Core.Entities.CommitmentFailFrequency", b =>
                {
                    b.Property<int>("CommitmentFailFrequencyId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("CommitmentFailFrequencyId");

                    b.HasIndex("FrequencyTypeId");

                    b.ToTable("CommitmentFailFrequency");
                });
            ...
            modelBuilder.Entity("Commitments.Core.Entities.Commitment", b =>
                {
                    ...
                    b.HasOne("Commitments.Core.Entities.CommitmentFailFrequency", "CommitmentFailFrequency")
                        .WithMany("Commitments")
                        .HasForeignKey("CommitmentFailFrequencyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Commitments.Core.Entities.CommitmentFrequency", "CommitmentFrequency")
                        .WithMany("Commitments")
                        .HasForeignKey("CommitmentFrequencyId")
                        .OnDelete(DeleteBehavior.Cascade);
