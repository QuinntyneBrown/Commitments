...
namespace Commitments.Core.Model.CardLayoutAggregate.Queries;
...
public class GetCardLayoutByIdRequestHandler : IRequestHandler<GetCardLayoutByIdRequest, GetCardLayoutByIdResponse>
{
    ...
    public GetCardLayoutByIdRequestHandler(ILogger<GetCardLayoutByIdRequestHandler> logger, ICommitmentsDbContext context)
    {
