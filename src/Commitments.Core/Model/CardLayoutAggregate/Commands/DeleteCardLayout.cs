...
namespace Commitments.Core.Model.CardLayoutAggregate.Commands;
...
public class DeleteCardLayoutRequestHandler : IRequestHandler<DeleteCardLayoutRequest, DeleteCardLayoutResponse>
{
    ...
    public DeleteCardLayoutRequestHandler(ILogger<DeleteCardLayoutRequestHandler> logger, ICommitmentsDbContext context)
    {
