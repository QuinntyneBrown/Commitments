...
namespace Commitments.Core.Model.CardAggregate.Queries;
...
public class GetCardByIdRequestHandler : IRequestHandler<GetCardByIdRequest, GetCardByIdResponse>
{
    ...
    public GetCardByIdRequestHandler(ILogger<GetCardByIdRequestHandler> logger, ICommitmentsDbContext context)
    {
