...
| 02 | [Daily Results — Dual-Mode](02-daily-results-dual-mode/README.md)                          | Accepted | Wire `DailyResultsTileComponent` to live & historical data; add `GET /commitment/daily-results?asOf`.    |
...
| 05 | [Outstanding Todos — Dual-Mode](05-outstanding-todos-dual-mode/README.md)                  | Draft  | Wire count endpoint with `asOf`, add delta-vs-today indicator in Review mode.                            |
