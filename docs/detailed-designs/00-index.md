...
| 07 | [Live Real-Time Metric Tile](07-live-real-time-metric-tile/README.md)                              | Accepted | Polished live tile matching `o0BgI`: large metric, delta vs yesterday, 14-day bar strip, SignalR updates. |
