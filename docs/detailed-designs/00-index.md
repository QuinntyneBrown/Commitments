...
| 02 | [Review Goal History](02-review-goal-history/README.md)       | Accepted | Scrub-through-history tile: pick a window, drag the slider, see the goal's count at any past instant. |
