...
| 04 | [Dashboard Mode Shell](04-dashboard-mode-shell/README.md)                                          | Accepted | First-class `live`/`review` mode state in `dashboard-framework`, persisted, exposed through tile context. |
