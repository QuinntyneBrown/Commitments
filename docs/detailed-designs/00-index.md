...
| 04 | [Monthly Progress — Dual-Mode](04-monthly-progress-dual-mode/README.md)                    | Accepted | Build snapshot endpoint, controller, and 4-bucket weekly aggregation with `asOf`.                      |
