...
| 08 | [Chart.js Line Chart Tile](08-chartjs-line-chart-tile/README.md)                                   | Accepted | Real-canvas Chart.js line chart (`9IpBQ`) with mode-aware highlighting and a reusable `ChartJsLineAdapter`. |
