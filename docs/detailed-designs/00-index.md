...
| 03 | [UI Tokens And Shared Components](03-ui-tokens-and-shared-components/README.md)                    | Draft    | Dark-theme tokens + reusable primitives in `commitments-ui` (mode toggle, status pill, icon button, tile shell, metric header, delta badge). |
