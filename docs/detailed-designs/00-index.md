...
| 03 | [UI Tokens And Shared Components](03-ui-tokens-and-shared-components/README.md)                    | Accepted | Dark-theme tokens + reusable primitives in `commitments-ui` (mode toggle, status pill, icon button, tile shell, metric header, delta badge). |
| 04 | [Dashboard Mode Shell](04-dashboard-mode-shell/README.md)                                          | Draft    | First-class `live`/`review` mode state in `dashboard-framework`, persisted, exposed through tile context. |
| 05 | [Gridster Layouts By Mode](05-gridster-layouts-by-mode/README.md)                                  | Draft    | Separate live / review Gridster layouts with isolated persistence and mode-aware FAB visibility. |
| 06 | [Review Scrubber Timeline](06-review-scrubber-timeline/README.md)                                  | Draft    | Dark scrubber bar with prev / play / next / today, publishing the selected review date into mode context. |
| 07 | [Live Real-Time Metric Tile](07-live-real-time-metric-tile/README.md)                              | Draft    | Polished live tile matching `o0BgI`: large metric, delta vs yesterday, 14-day bar strip, SignalR updates. |
| 08 | [Chart.js Line Chart Tile](08-chartjs-line-chart-tile/README.md)                                   | Draft    | Real-canvas Chart.js line chart (`9IpBQ`) with mode-aware highlighting and a reusable `ChartJsLineAdapter`. |
| 09 | [Review Goal History Tile Polish](09-review-goal-history-tile-polish/README.md)                    | Draft    | Polished review tile (`nAfUX`) consuming the global scrubber date with selected-date badge and delta vs today. |
| 10 | [Mode-Aware Plugin Contracts](10-mode-aware-plugin-contracts/README.md)                            | Draft    | Tile registration metadata for supported modes, per-mode component maps, and tile context with refresh hooks. |
