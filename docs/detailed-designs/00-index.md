...
| 11 | [Backend Trend And Snapshot Endpoints](11-backend-trend-and-snapshot-endpoints/README.md)          | Accepted | `/current`, `/at`, `/trend` endpoints with bounded queries, indexes, and cache headers. |
