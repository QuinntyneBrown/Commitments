...
public class DashboardController
{
    ...
    public DashboardController(ISender sender, ILogger<DashboardController> logger, IHttpContextAccessor httpContextAccessor)
    {
    ...
    public async Task<ActionResult<GetDashboardByProfileIdResponse>> GetByCurrentProfile()
    {
        ...
        return await _sender.Send(new GetDashboardByProfileIdRequest() { ProfileId = profileId });
    }

    [SwaggerOperation(Summary = "Update Dashboard", Description = "Update Dashboard")]
    ...
    [SwaggerOperation(Summary = "Create Dashboard", Description = "Create Dashboard")]
    ...
    [SwaggerOperation(Summary = "Get Dashboards", Description = "Get Dashboards")]
    ...
    [SwaggerOperation(Summary = "Get Dashboard by id", Description = "Get Dashboard by id")]
    ...
    public async Task<ActionResult<GetDashboardByIdResponse>> GetById([FromRoute] Guid dashboardId, CancellationToken cancellationToken)
    {
        ...
        if (response.Dashboard == null) return new NotFoundObjectResult(request.DashboardId);
        return response;
    }

    [SwaggerOperation(Summary = "Delete Dashboard", Description = "Delete Dashboard")]
    ...
    {
        return await _sender.Send(new DeleteDashboardRequest() { DashboardId = dashboardId }, cancellationToken);
    }
}
